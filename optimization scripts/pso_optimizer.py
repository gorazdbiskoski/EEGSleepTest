...
def run_pso(dataset_name, X, y):
    ...
    def objective_function(particles):
        ...
        for p in particles:
            ...
            if loss < global_best_loss[0]:
                ...
                global_best_metrics[0] = metrics_from(result)
    ...
    if global_best_pos[0] is not None:
        ...
        best_metrics = global_best_metrics[0]
    else:
        best_metrics = None

    return results_log, best_pos, best_cost, best_metrics, elapsed


def append_best_to_summary(best_pos, best_loss, best_metrics, elapsed, dataset_name):
...
if __name__ == "__main__":
    ...
    for dataset_name, dataset in datasets.items():
        ...
        results, best_pos, best_loss, best_metrics, elapsed = run_pso(dataset_name, X, y)
        ...
        append_best_to_summary(best_pos, best_loss, best_metrics, elapsed, dataset_name)
